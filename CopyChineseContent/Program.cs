...
var chineseDbSystemPath = @"D:\BaiduNetdiskDownload\传永开区端\CopyChineseCountent\Chinese\System";
// var mir3dDbSystemPath = @"D:\Descargas\YH191\Database\English\System";
var mir3dDbSystemPath = @"D:\BaiduNetdiskDownload\传永开区端\CopyChineseCountent\English\System";
...
string ConvertBuffJudgmentType(string chinese)
{
  switch (chinese)
  {
    ...
    case "来源特定伤害":
      return "SourceSpecificDamage";
    case "所有魔法伤害":
      return "AllMagicDamage";
    default:
      throw new ApplicationException();
  }
}
...
string ConvertBuffDetherminationMethod(string chinese)
{
  switch (chinese)
  {
    ...
    case "主动攻击增伤":
      return "ActiveAttackDamageBoost";
    default:
      throw new ApplicationException();
  }
}
